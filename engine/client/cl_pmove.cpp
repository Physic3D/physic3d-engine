...
void ItemPreFrame( local_state_t *from, local_state_t *to, usercmd_t *cmd, int runfuncs, double time, unsigned int random_seed )
{
	...
	g_Local.iHealth                        = to->client.health; // ZP4.3fix5a kullanan sunucularda health infoyu bir �ekilde alam�yorum 511 den fazla yukar� ��km�yor bu durum nextclientde de ayn� bunun bi ��z�m� yok san�r�m.
}
...
void CL_InitClientMove( void )
{
	...
	// common utilities
	clgame.pmove->PM_Info_ValueForKey = (const char *(*)(const char *, const char *))(void*)Info_ValueForKey;
	...
	clgame.pmove->RandomLong = (long (*)(long, long))(void*)Com_RandomLong;
	...
	clgame.pmove->PM_HullForBsp = (void *(*)(physent_t *, float *))(void*)pfnHullForBsp;
	clgame.pmove->PM_TraceModel = pfnTraceModel;
	clgame.pmove->COM_FileSize = (int (*)(char *))(void*)COM_FileSize;
	clgame.pmove->COM_LoadFile = (byte *(*)(char *, int, int *))(void*)COM_LoadFile;
	...
	{
		clgame.pmove->PM_PlayerTrace = (pmtrace_t (*)(float*, float*, int, int))pfnPlayerTrace_w32;
		clgame.pmove->PM_PlayerTraceEx = (pmtrace_t (*)(float*, float*, int, int (*)(physent_t*)))pfnPlayerTraceEx_w32;
	}
#endif
