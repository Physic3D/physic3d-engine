...
static void R_StudioDrawPoints_legacy( void )
{
	...
	if( r_studio_sort_textures->integer )
	{
		...
		qsort( g_sortedMeshes, m_pSubModel->nummesh, sizeof( sortedmesh_t ), (int (*)(const void *, const void *))R_StudioMeshCompare );
	}
