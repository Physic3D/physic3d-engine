/*
cl_game.c - client game interface
...
#pragma warning(disable: 4133 4113) // function pointer type compatibility (qboolean vs int, etc.)
...
extern "C" triangleapi_t gTriApi =
{
	TRI_API_VERSION,	
	TriRenderMode,
	TriBegin,
	...
	TriColor4ub,
	TriTexCoord2f,
	(void (__cdecl *)(float *))TriVertex3fv,
	TriVertex3f,
	TriBrightness,
	TriCullFace,
	(int (__cdecl *)(struct model_s *, int))TriSpriteTexture,
	(int (__cdecl *)(float *, float *))R_WorldToScreen,	// NOTE: XPROJECT, YPROJECT should be done in client.dll
	TriFog,
	(void (__cdecl *)(float *, float *))R_ScreenToWorld,
	TriGetMatrix,
	TriBoxInPVS,
	TriLightAtPoint,
	TriColor4fRendermode,
...
{
	CL_AllocParticle,
	(void (__cdecl *)(float *))CL_BlobExplosion,
	(void (__cdecl *)(float *, float *, int, int))CL_Blood,
	(void (__cdecl *)(float *, int, int, int, float))CL_BloodSprite,
	(void (__cdecl *)(float *, float *, int, int))CL_BloodStream,
	(void (__cdecl *)(float *, float *, float *, float, float, int, int, char))CL_BreakModel,
	(void (__cdecl *)(float *, float *, float, int, int, float))CL_Bubbles,
	(void (__cdecl *)(float *, float *, float, int, int, float))CL_BubbleTrail,
	(void (__cdecl *)(float *))CL_BulletImpactParticles,
	CL_EntityParticles,
	(void (__cdecl *)(float *, int, float, float, int))CL_Explosion,
	CL_FizzEffect,
	CL_FireField,
	(void (__cdecl *)(float *))CL_FlickerParticles,
	(void (__cdecl *)(float *, int, int))CL_FunnelSprite,
	(void (__cdecl *)(float *, float, int, float))CL_Implosion,
	(void (__cdecl *)(float *, int))CL_Large_Funnel,
	(void (__cdecl *)(float *))CL_LavaSplash,
	(void (__cdecl *)(float *, float *, float *, int, int, int *))CL_MultiGunshot,
	(void (__cdecl *)(float *, int))CL_MuzzleFlash,
	(void (__cdecl *)(float *, float *, unsigned char, unsigned char, unsigned char, float))CL_ParticleBox,
	(void (__cdecl *)(float *, int, int, float))CL_ParticleBurst,
	(void (__cdecl *)(float *))CL_ParticleExplosion,
	(void (__cdecl *)(float *, int, int))CL_ParticleExplosion2,
	(void (__cdecl *)(float *, float *, unsigned char, unsigned char, unsigned char, float))CL_ParticleLine,
	CL_PlayerSprites,
	(void (__cdecl *)(float *, float *, int, int, int, void (__cdecl *)(struct tempent_s *, struct pmtrace_s *)))CL_Projectile,
	(void (__cdecl *)(float *))CL_RicochetSound,
	(void (__cdecl *)(float *, struct model_s *, float, float))CL_RicochetSprite,
	(void (__cdecl *)(float *))CL_RocketFlare,
	(void (__cdecl *)(float *, float *, int))CL_RocketTrail,
	(void (__cdecl *)(float *, float *, int, int))CL_RunParticleEffect,
	(void (__cdecl *)(float *, float *))CL_ShowLine,
	(void (__cdecl *)(float *, int, int, int))CL_SparkEffect,
	(void (__cdecl *)(float *))CL_SparkShower,
	(void (__cdecl *)(float *, int, int, int))CL_SparkStreaks,
	(void (__cdecl *)(float *, float *, int, int, int, int, int))CL_Spray,
	CL_Sprite_Explode,
	CL_Sprite_Smoke,
	(void (__cdecl *)(float *, float *, int, int, int, int))CL_Sprite_Spray,
	(void (__cdecl *)(int, float *, float *, int, int, float, float, float, int, float))CL_Sprite_Trail,
	CL_Sprite_WallPuff,
	(void (__cdecl *)(float *, float *, int, int, float, int, int))CL_StreakSplash,
	(void (__cdecl *)(float *, float *))CL_TracerEffect,
	CL_UserTracerParticle,
	CL_TracerParticles,
	(void (__cdecl *)(float *))CL_TeleportSplash,
	(void (__cdecl *)(float *, float, float, int, int))CL_TempSphereModel,
	(TEMPENTITY *(__cdecl *)(float *, float *, float *, float, int, int))CL_TempModel,
	(TEMPENTITY *(__cdecl *)(float *, int, float))CL_DefaultSprite,
	(TEMPENTITY *(__cdecl *)(float *, float *, float, int, int, int, float, float, int))CL_TempSprite,
	CL_DecalIndex,
	(int (__cdecl *)(char *))CL_DecalIndexFromName,
	CL_DecalShoot,
	CL_AttachTentToPlayer,
	CL_KillAttachedTents,
	(BEAM *(__cdecl *)(int, float *, float *, int, float, float, float, float, float, int, float, float, float, float))CL_BeamCirclePoints,
	(BEAM *(__cdecl *)(int, float *, int, float, float, float, float, float, int, float, float, float, float))CL_BeamEntPoint,
	CL_BeamEnts,
	CL_BeamFollow,
	CL_BeamKill,
	(BEAM *(__cdecl *)(float *, float *, int, float, float, float, float, float))CL_BeamLightning,
	(BEAM *(__cdecl *)(float *, float *, int, float, float, float, float, float, int, float, float, float, float))CL_BeamPoints,
	CL_BeamRing,
	CL_AllocDlight,
	CL_AllocElight,
	(TEMPENTITY *(__cdecl *)(float *, struct model_s *))CL_TempEntAlloc,
	(TEMPENTITY *(__cdecl *)(float *))CL_TempEntAllocNoModel,
	(TEMPENTITY *(__cdecl *)(float *, struct model_s *))CL_TempEntAllocHigh,
	(TEMPENTITY *(__cdecl *)(float *, struct model_s *, int, void (__cdecl *)(struct tempent_s *, float, float)))CL_TempEntAllocCustom,
	CL_GetPackedColor,
	CL_LookupColor,
	CL_DecalRemoveAll,
	CL_FireCustomDecal,
...
static cl_enginefunc_t gEngfuncs = 
{
	...
	pfnGetScreenInfo,
	pfnSetCrosshair,
	(struct cvar_s *(__cdecl *)(char *, char *, int))pfnCvar_RegisterVariable,
	(float (__cdecl *)(char *))Cvar_VariableValue,
	(char *(__cdecl *)(char *))Cvar_VariableString,
	(int (__cdecl *)(char *, void (__cdecl *)(void)))pfnAddClientCommand,
	(int (__cdecl *)(char *, pfnUserMsgHook))pfnHookUserMsg,
	(int (__cdecl *)(char *))pfnServerCmd,
	(int (__cdecl *)(char *))pfnClientCmd,
	pfnGetPlayerInfo,
	(void (__cdecl *)(char *, float))pfnPlaySoundByName,
	pfnPlaySoundByIndex,
	AngleVectors,
	CL_TextMessageGet,
	pfnDrawCharacter,
	...
	pfnSetViewAngles,
	CL_GetMaxClients,
	(void (__cdecl *)(char *, float))Cvar_SetFloat,
	Cmd_Argc,
	Cmd_Argv,
	Con_Printf,
	Con_DPrintf,
	...
	pfnCalcShake,
	pfnApplyShake,
	(int (__cdecl *)(float *, int *))pfnPointContents,
	(int (__cdecl *)(float *))CL_WaterEntity,
	pfnTraceLine,
	CL_LoadModel,
	CL_AddEntity,
	CL_GetSpritePointer,
	...
	Com_RandomFloat,
	Com_RandomLong,
	(void (__cdecl *)(char *, void (__cdecl *)(struct event_args_s *)))pfnHookEvent,
	Con_Visible,
	pfnGetGameDirectory,
	pfnCVarGetPointer,
	Key_LookupBinding,
	...
	(byte *(__cdecl *)(char *, int, int *))COM_LoadFile,
	COM_ParseFile,
	COM_FreeFile,
	&gTriApi,
	&gEfxApi,
	...
	pfnSetMouseEnable,
	Cvar_GetList,
	(void *(__cdecl *)(void))Cmd_GetFirstFunctionHandle,
	(void *(__cdecl *)(void *))Cmd_GetNextFunctionHandle,
	(const char *(__cdecl *)(void *))Cmd_GetName,
	pfnGetClientOldTime,
	pfnGetGravity,
	Mod_Handle,
	pfnEnableTexSort,
	...
	pfnVGUI2DrawCharacter,
	pfnVGUI2DrawCharacterAdditive,
	(unsigned int (__cdecl *)(char *))Sound_GetApproxWavePlayLen,
	GetCareerGameInterface,
	(void (__cdecl *)(char *, char *))Cvar_Set,
	pfnIsCareerMatch,
	pfnPlaySoundVoiceByName,
	pfnMP3_InitStream,
	Sys_DoubleTime,
...
extern "C" void Sequence_Init( void );
...
qboolean CL_LoadProgs( const char *name )
{
	...
	if(( F = (CL_EXPORT_FUNCS)Com_GetProcAddress( clgame.hInstance, "F" )) != NULL )
	{
