...
{
	(HIMAGE (*)(const char *, const byte *, long, long))pfnPIC_Load,
	GL_FreeImage,
	pfnPIC_Width,
	pfnPIC_Height,
	pfnPIC_Set,
	...
	Cmd_Argv,
	Cmd_Args,
	(void (__cdecl *)(const char *,...))Con_Printf,
	(void (__cdecl *)(const char *,...))Con_DPrintf,
	(void (__cdecl *)(int, const char *,...))UI_NPrintf,
	(void (__cdecl *)(struct con_nprint_s *, const char *,...))UI_NXPrintf,
	pfnPlaySound,
	UI_DrawLogo,
	UI_GetLogoWidth,
	UI_GetLogoHeight,
