...
static void Huff_IncrementFreq_r( void **tree1, void **tree2 )
{
	...
	if( tree2[2] )
	{
		Huff_IncrementFreq_r( (void**)tree1, (void**)tree2[2] );
...
{
	if( tree[2] ) Huff_EmitPathToByte( (void**)tree[2], tree, buffer );
	if( !subtree ) return;
