...
int feed_mpeg_header( void *mpg, const char *data, long bufsize, long streamsize, wavinfo_t *sc )
{
	...
	ret = mpg123_decode( mh, (const byte *)data, bufsize, NULL, 0, NULL );
...
{
	switch( mpg123_decode( (mpg123_handle_t *)mpg, (const byte *)data, bufsize, (byte *)outbuf, OUTBUF_SIZE, outsize ))
	{
