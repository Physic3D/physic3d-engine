...
void SV_InitClientMove( void )
{
	...
	// common utilities
	svgame.pmove->PM_Info_ValueForKey = (const char *(*)(const char *, const char *))(void*)Info_ValueForKey;
	...
	svgame.pmove->RandomLong = (long (*)(long, long))(void*)Com_RandomLong;
	...
	svgame.pmove->PM_HullForBsp = (void *(*)(physent_t *, float *))(void*)pfnHullForBsp;
	svgame.pmove->PM_TraceModel = pfnTraceModel;
	svgame.pmove->COM_FileSize = (int (*)(char *))(void*)COM_FileSize;
	svgame.pmove->COM_LoadFile = (byte *(*)(char *, int, int *))(void*)COM_LoadFile;
	...
	{
		svgame.pmove->PM_PlayerTrace = (pmtrace_t (*)(float*, float*, int, int))pfnPlayerTrace_w32;
		svgame.pmove->PM_PlayerTraceEx = (pmtrace_t (*)(float*, float*, int, int (*)(physent_t*)))pfnPlayerTraceEx_w32;
	}
#endif
